...
class Profile(models.Model):
    ...
    # User.objects.get(some_criteria).is_following.all() == User.objects.get(some_criteria).profile.followers.all()
    # thus we don't need:
    # following         = models.ManyToManyField(User, related_name='is_following', blank=True) # user.following
...
def post_save_user_receiver(sender, instance, created, *args, **kwargs):
    ...
    if created:
        ...
        # you don't need to save(), you simply call add() or remove()
